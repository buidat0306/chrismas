            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Mùa giáng sinh là mùa giá rét. Nhưng khi có em cầm tay anh, mùa giá rét trở thành mùa nồng ấm. Mong tình yêu của chúng mình sẽ mãi là ngọn lửa xua tan lạnh giá của mùa đông!!",
                        ],
                        typeSpeed: 250,
                        startDelay: 500,
                        backSpeed: 50,
